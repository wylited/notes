...
var _chunk3QN2I3PMjs = require('./chunk-3QN2I3PM.js');


var _chunkDH356VJWjs = require('./chunk-DH356VJW.js');
...
function babelParse(code, lang, options = {}) {
  ...
  if (_chunk3QN2I3PMjs.isTs.call(void 0, lang)) {
    plugins.push(["typescript", { dts: lang === "dts" }]);
    if (_chunkDH356VJWjs.REGEX_LANG_JSX.test(lang))
      plugins.push("jsx");
