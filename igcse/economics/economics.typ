...
= Preface
This is a revision guide made for the IGCSE Economics course. It is not made to be used on its own, but rather to promote understanding and help condense and compress key information in the course. Thiss allows for a more efficient revision process, and helps students make connections between topics efficiently. This greatly helps for the extended response questions.
...
=== AO3
Select, organise and interpret information from sources to investigate and analyse economic issues.
...
The *opportunity cost* is the cost giving up _next best alternative_ when a choice is made.

Choosing what goods to produce is an opportunity cost, This can be illustrated using a PPC (Production Possibility Curve).

The PPC shows the maximum amount of goods that can be produced with the available resources. Often it shows the relationship between two goods.
...
+ Point A & C are efficient (maximising output with the resources available)
...
+ Consumers aim to maximise benfits or util.
...
+ For producers:
    ...
    + Perfomance may be influenced by other aims like selling more goods
...
== Demand and Supply
=== Demand
"The amount of a economic good that would be bought at a certain price point."
...
PED is equal to the change in quantity demand over the change in price. This is also the gradient of the curve.
...
+ *Addictivity* - The more addictive a good is, the higher the PED (proportional)
...
+ YED and the Economy
  ...
  - Low YED for primary commodoties
...
"The amount of a economic good that can be produced at a certain price point."
...
+ Expectations at firms - goods may be withold if prices are expected to rise
...
+ Primary commodoties have lower PES than manufactured goods because
  ...
  - Better irrigation systems are needed for cultivaition of crops.
